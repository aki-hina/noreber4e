...
class Timer:
    def __init__(self, master):
        ...
        self.hours_label = tk.Label(self.timer_frame, text="00", font=("Helvetica", 72))
        ...
        self.separator3_label = tk.Label(self.timer_frame, text=".", font=("Helvetica", 72))
        self.separator3_label.pack(side=tk.LEFT)


        self.milliseconds_label = tk.Label(self.timer_frame, text="00", font=("Helvetica", 72))
        ...
        self.hours_button = tk.Button(self.button_frame, text="時", command=self.increment_hours, font=("Helvetica", 24))
        self.hours_button.pack(side=tk.LEFT)


        self.minutes_button = tk.Button(self.button_frame, text="分", command=self.increment_minutes, font=("Helvetica", 24))
        self.minutes_button.pack(side=tk.LEFT)


        self.seconds_button = tk.Button(self.button_frame, text="秒", command=self.increment_seconds, font=("Helvetica", 24))
        self.seconds_button.pack(side=tk.LEFT)


        self.reset_button = tk.Button(self.button_frame, text="リセット", command=self.reset_timer, font=("Helvetica", 24))
        self.reset_button.pack(side=tk.LEFT)


        self.start_stop_button = tk.Button(self.button_frame, text="スタート", command=self.start_stop_timer, font=("Helvetica", 24))
